...
try {
    ...
    // Contenu du mail
    $mail->isHTML(true);
    $mail->Subject = "Confirmation d'annulation de votre reservation";
    $mail->Body    = "
        <h2>RDV annulé !</h2>
        <p>Bonjour ".$name.",</p>
        <p>Votre séance pour le <b>" .date('d/m/Y à H:i', strtotime($start)) . "</b> a été annulé</p>
        <p>Nous avons hâte de vous rencontrer une prochaine fois !</p>
        <p>
            Cordialement, 
            <br>
